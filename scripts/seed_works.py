...
def perseus_url(phi_work: str) -> str:
    """Canonical Perseus CTS URN URL pattern for Cicero (PHI 0474)."""
    return f"https://scaife.perseus.org/library/urn:cts:latinLit:phi0474.phi{phi_work}/"
...
SPEECHES: list[dict[str, Any]] = [
    ...
    {"id": "in-verrem-2-1", "title_latin": "In C. Verrem Actio Secunda I",
     ...
     "year": 70, "month": None, "day": None, "precision": "year",
     "phi": "004", "ll_slug": "verres.2.1",
     "location": "Rome",
     "notes": "The Second Action was never delivered (Verres had already gone into exile) but published as a written prosecution. Book I treats Verres' early career."},

    {"id": "in-verrem-2-2", "title_latin": "In C. Verrem Actio Secunda II",
     "title_english": "Against Verres, Second Hearing, Book II",
     "year": 70, "month": None, "day": None, "precision": "year",
     "phi": "005", "ll_slug": "verres.2.2",
     "location": "Rome",
...
def _speech_entry(s: dict[str, Any]) -> dict[str, Any]:
    ...
    entry: dict[str, Any] = {
        ...
        "latin_source_url": perseus_url(s["phi"]),
